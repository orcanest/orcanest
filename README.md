...
Junior DevOps Engineer with hands-on experience in containerization (Docker + Docker Compose), CI/CD pipeline development (GitLab CI), and Linux server administration. Proficient in Ansible for configuration management and infrastructure automation. Currently expanding Kubernetes expertise through homelab projects.

📍 Based in Mashhad - Immediately relocatable to Tehran</br>
🛠️ Projects & Configs: orcanest.com · GitHub in bio</br>
🎯 Seeking junior DevOps roles (Remote/On-site in Tehran)</br>
